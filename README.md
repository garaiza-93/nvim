...
All plugin configurations are in the **config** directory
 ...
 - [bufferline](https://github.com/akinsho/bufferline.nvim) gives tabs that allow for neater switching between buffers. There's an **x** in the top-right that's meant to close nvim, but it doesn't work yet.
